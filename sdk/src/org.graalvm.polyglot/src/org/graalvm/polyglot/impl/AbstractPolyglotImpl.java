...
public abstract class AbstractPolyglotImpl {
    ...
    public abstract static class AbstractHostAccess extends AbstractDispatchClass {
        ...
        public abstract Object toMappedObjectProxy(Object internalContext, Class<?> clazz, Object obj, Map<String, String> executables, Map<String, String> instantiables, Map<String, String> getters, Map<String, String> setters) throws IllegalArgumentException;
    ...
    public Object newProxyTargetType(Class<?> from, Class<?> to, Map<String, String> executables, Map<String, String> instantiables, Map<String, String> getters, Map<String, String> setters) {
        return getNext().newProxyTargetType(from, to, executables, instantiables, getters, setters);
    }
